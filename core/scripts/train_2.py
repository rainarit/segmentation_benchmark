...
from segmentation_benchmark.core.models.segmentation.segmentation import _load_model
import segmentation_benchmark
...
def parse_args():
    ...
    parser.add_argument('--dist-url', default='env:// /home/AD/rraina/segmentation_benchmark/', help='url used to set up distributed training')
