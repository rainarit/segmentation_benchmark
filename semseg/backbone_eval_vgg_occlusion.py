...
def main_worker(gpu, args):
    ...
    stats_file = open(os.path.join(str(args.checkpoint_dir), 'stats_eval_occlude_%s_%s.txt' % (args.occlude_low, args.occlude_high)), 
                        'a', buffering=1)
    ...
    occlude_dict = {"occlude_low": args.occlude_low, "occlude_high": args.occlude_high, "val_accuracy": val_acc1.item()}
