...
pkill bench
python3 -m torch.distributed.launch --nproc_per_node=2 --use_env train.py --lr 0.02 --dataset voc -b 16 --model deeplabv3 --backbone resnet50 --data-path /home/AD/rraina/segmentation_benchmark --tensorboard-dir deeplabv3_resnet50 --aux-loss
pkill bench
