...
python3 -m torch.distributed.launch --nproc_per_node=1 --master_port 17006 --use_env train_optimize.py --lr 0.02 --epochs 30 --dataset voc_aug -b 32 --model deeplabv3 --backbone resnet_divnormresnet50 --data-path /home/AD/rraina/segmentation_benchmark/benchmark_RELEASE/dataset --aux-loss
