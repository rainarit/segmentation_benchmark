...
# # Train model
# pkill bench
# python3 -m torch.distributed.launch --nproc_per_node=4 --use_env train.py --lr 0.02 --dataset voc -b 8 --model deeplabv3 --backbone resnet_divnormresnet50 --data-path /home/AD/rraina/segmentation_benchmark --tensorboard-dir deeplabv3_resnet_divnormresnet50 --aux-loss
# pkill bench
# # Evaluate Model
# pkill bench
